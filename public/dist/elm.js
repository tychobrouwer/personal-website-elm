...
var $author$project$Api$Project$Project = F7(
	function (image, imageSecondary, imageBanner, name, title, markdown, links) {
		return {image: image, imageBanner: imageBanner, imageSecondary: imageSecondary, links: links, markdown: markdown, name: name, title: title};
	});
...
var $author$project$Api$Project$emptyProject = {image: '', imageBanner: '', imageSecondary: '', links: _List_Nil, markdown: '', name: '', title: ''};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(options.projectComponent.markdown)
					])),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
