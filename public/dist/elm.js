			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$core$String$toLower(options.text) + (' link-hover link__icon ' + options.icon))
					]),
				_List_Nil)
			]));
};
var $author$project$UI$icons = {email: 'fa-solid fa-paper-plane', github: 'fa-brands fa-github', left: 'fa-solid fa-chevron-left', linkedin: 'fa-brands fa-linkedin', mastodon: 'fa-brands fa-mastodon', reddit: 'fa-brands fa-reddit', right: 'fa-solid fa-chevron-right'};
