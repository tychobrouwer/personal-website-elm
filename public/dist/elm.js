...
var $author$project$Api$Project$Project = F8(
	function (image, imageSecondary, imageBanner, name, title, tags, markdown, links) {
		return {image: image, imageBanner: imageBanner, imageSecondary: imageSecondary, links: links, markdown: markdown, name: name, tags: tags, title: title};
	});
...
var $author$project$Api$Project$emptyProject = {image: '', imageBanner: '', imageSecondary: '', links: _List_Nil, markdown: '', name: '', tags: _List_Nil, title: ''};
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('projects__section-title')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(project.title)
