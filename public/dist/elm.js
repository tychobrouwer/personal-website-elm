			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$core$String$toLower(options.text) + ' link-hover link__icon '),
						$elm$html$Html$Attributes$src($author$project$Env$domain + ('/images/icons/' + (options.icon + '.svg')))
					]),
				_List_Nil)
			]));
};
var $author$project$UI$icons = {email: 'paper-plane', github: 'github', left: 'chevron-left', linkedin: 'linkedin', mastodon: 'mastodon', reddit: 'reddit', right: 'chevron-right'};
