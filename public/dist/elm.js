					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(options.sub_description)
									]))
							]))
					]))
			]));
		...
		[
			...
			_List_fromArray(
				[
					...
					{description: 'A site for showcasing my projects', sub_description: 'current, finished, and never finished', title: 'Tycho Brouwer'}),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
