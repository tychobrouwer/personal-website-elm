...
var $author$project$Api$Project$Project = F7(
	function (image, imageSecondary, name, title, markdown, internal, external) {
		return {external: external, image: image, imageSecondary: imageSecondary, internal: internal, markdown: markdown, name: name, title: title};
	});
...
var $author$project$Api$Project$emptyProject = {external: _List_Nil, image: '', imageSecondary: '', internal: _List_Nil, markdown: '', name: '', title: ''};
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$src('images/projects/' + (project.image + '.webp')),
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$src('images/projects/' + (project.imageSecondary + '.webp')),
									$elm$html$Html$Attributes$alt(
									A3($elm$core$String$replace, '_', ' ', project.image))
								]),
							_List_Nil)
		...
		if (projects.$ === 'Success') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						projectComponent: $elm$core$Maybe$Just(
							{external: a.external, image: a.image, internal: a.internal, markdown: a.markdown, name: a.name, title: a.title})
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(options.projectComponent.image)
					]),
				_List_Nil)
			]));
};
