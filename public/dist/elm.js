								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$src($author$project$Env$domain + '/images/tycho.webp'),
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$Attributes$href('https://www.linkedin.com/in/tycho-brouwer-6306ba274/'),
																	$elm$html$Html$Attributes$target('_blank')
																]),
															_List_fromArray(
																[
																	$elm$html$Html$text('linkedin.com/tycho-brouwer')
																]))
														]))
												])),
											A2(
...
var $author$project$Pages$Home_$init = function (_v0) {
	return _Utils_Tuple2(
		{elementId: 0, project: $author$project$Api$Data$Loading, projectsData: _List_Nil},
...
var $author$project$Pages$Home_$getNextIndex = F3(
	function (up, index, length) {
		return (up && _Utils_eq(index, length - 1)) ? 0 : (((!up) && (!index)) ? (length - 1) : (up ? (index + 1) : (index - 1)));
	});
...
var $author$project$Api$Project$getProjectName = F2(
	function (idx, projects) {
		return A2(
			$elm$core$Maybe$withDefault,
				...
				return _Utils_Tuple2(
					...
					$author$project$Ports$scrollToElement(
						A2(
							...
							model.projectsData)));
			default:
				var scrollData = msg.a;
				return _Utils_Tuple2(
					model,
					$author$project$Ports$scroll(scrollData.deltaX));
		}
	});
...
var $author$project$Components$Carousel$carousel = function (sections) {
	var viewSection = function (project) {
		return A2(
			$elm$html$Html$a,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id(project.name),
					$elm$html$Html$Attributes$class('carousel__section'),
					$elm$html$Html$Attributes$href($author$project$Env$domain + ('/projects/' + project.name))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('carousel__section-col')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('carousel__section-title')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('carousel__section-image'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$id('carousel')
			]),
		A2($elm$core$List$map, viewSection, sections));
};
...
var $author$project$Pages$Home_$ScrollEvent = F2(
	function (deltaX, deltaY) {
		return {deltaX: deltaX, deltaY: deltaY};
	});
var $author$project$Pages$Home_$andMap = $elm$json$Json$Decode$map2($elm$core$Basics$apR);
var $author$project$Pages$Home_$scrollDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$Pages$Home_$Scroll,
	A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Components$Carousel$carousel(model.projectsData),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick($author$project$Pages$Home_$ScrollElementLeft),
											$elm$html$Html$Attributes$class('carousel_arrow left')
										]),
									_List_fromArray(
										[$author$project$UI$icons.left])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick($author$project$Pages$Home_$ScrollElementRight),
											$elm$html$Html$Attributes$class('carousel_arrow right')
										]),
									_List_fromArray(
										[$author$project$UI$icons.right]))
								]))
						])),
					$author$project$Components$Footer$footer
				]),
					...
					return A2(
						...
						(!A2($elm$core$Basics$modBy, 2, idx)) ? _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('project__section-right')
									]),
								_List_fromArray(
									[
