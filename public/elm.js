...
var $author$project$UI$Layout$navbar = function (_v0) {
	...
	var navLink = function (options) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('bold v-margin text-medium link-hover'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('link-hover')
						]),
					_List_fromArray(
						[
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$UI$iconLink(
								{icon: $author$project$UI$icons.reddit, text: 'Reddit', url: 'https://www.reddit.com/user/DS-Cloav'}),
								$author$project$UI$iconLink(
								{icon: $author$project$UI$icons.mastodon, text: 'Mastodon', url: 'https://hackaday.social/@tycho'})
							]))
					]))
			]));
};
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('I\'m a currently a Mechanical Engineering student at the Techinische Universiteit Eindhoven in the Netherlands and interested in everything from software to control engineering.')
										])),
									A2(
									$elm$html$Html$p,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text('My journey into technology begun at a young age when my grand father dug up one of his first personal computers, a TRS-80 Color Computer. On this I wrote my first code in BASIC.')
										])),
									A2(
									$elm$html$Html$p,
									_List_Nil,
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$text('Since then I been learning and playing around  with a wide range of programming languages. Starting with C++ on various microcontrollers and web development using HTML, JavaScript, and CSS. I quickly moved on to Python, PHP, SQL, TypeScript, SASS, and more recently Dart and Elm.')
										]))
								]))
						]))
				]))
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(options.description)
									])),
								A2(
								$elm$html$Html$h2,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(options.subdescription)
									]))
							]))
					]))
			]));
		...
		[
			...
			_List_fromArray(
				[
					...
					{description: 'A site for showcasing my projects', subdescription: 'current, never finished, and finished', title: 'Tycho Brouwer'}),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
